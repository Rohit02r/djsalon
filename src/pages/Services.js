    ...
    <section id="services" className="services-section pt-5">
      <div className="container">
        ...
        <p className="services-intro">
          We are providing world-class beauty and wellness services to ensure you look and feel your best. Our experienced team is dedicated to delivering exceptional results with a touch of luxury.
        </p>
        <div className="row">
