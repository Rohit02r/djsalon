...
const Products = () => {
  ...
  const products = [
    { img: Shampoo, title: 'Shampoo', description: 'Nourishing shampoo for healthy hair.', price: 299 },
    { img: FaceCream, title: 'Face Cream', description: 'Hydrating face cream for a radiant complexion.', price: 499 },
    { img: BeardOil, title: 'Beard Oil', description: 'Softens and conditions your beard.', price: 399 },
    { img: HairOil, title: 'Hair Oil', description: 'Revitalizing oil for stronger hair.', price: 349 },
    { img: Comb, title: 'Comb', description: 'High-quality comb for all hair types.', price: 149 },
    { img: Sunscreen, title: 'Sunscreen', description: 'Protects your skin from harmful UV rays.', price: 599 },
    { img: BodyLotion, title: 'Body Lotion', description: 'Moisturizing lotion for smooth skin.', price: 399 },
    { img: NeemFaceWash, title: 'Neem Face Wash', description: 'Cleansing face wash for a fresh feel.', price: 249 },
    { img: TermericFaceWash, title: 'Termeric Face Wash', description: 'Revitalizing eye cream to reduce dark circles.', price: 699 },
  ];
